...
class UserTest extends \Base {
    ...
    public function testDeleteUserShouldReturnAResponsePayloadIfAnIDIsProvided()
    {
        ...
        $delete_res = $this->chatkit->asyncDeleteUser([ 'id' => $user_id ]);
    ...
    public function testGetDeleteUserStatusShouldReturnAResponsePayloadIfAnIDIsProvided()
    {
        $user_id = $this->guidv4(openssl_random_pseudo_bytes(16));
        $res = $this->chatkit->createUser([
            'id' => $user_id,
        ...
        $status_res = $this->chatkit->getDeleteUserStatus([ 'id' => $job_id ]);
